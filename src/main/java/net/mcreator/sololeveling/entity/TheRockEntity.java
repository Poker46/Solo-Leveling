...
import net.mcreator.sololeveling.entity.renderer.TheRockRenderer;
...
public class TheRockEntity extends SololevelingModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 2.6f))
					.build("the_rock").setRegistryName("the_rock");
	public TheRockEntity(SololevelingModElements instance) {
		super(instance, 28);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TheRockRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -6710887, -1, new Item.Properties().group(IdtItemGroup.tab)).setRegistryName("the_rock_spawn_egg"));
	}
