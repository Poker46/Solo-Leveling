...
public class LightingSpearItem extends SololevelingModElements.ModElement {
	@ObjectHolder("sololeveling:lighting_spear")
	public static final Item block = null;
	public LightingSpearItem(SololevelingModElements instance) {
		super(instance, 29);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("lighting_spear"));
	}
}
