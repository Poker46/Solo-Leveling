...
import net.mcreator.sololeveling.entity.renderer.VikingRenderer;
import net.mcreator.sololeveling.SololevelingModElements;

@SololevelingModElements.ModElement.Tag
public class VikingEntity extends SololevelingModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("undead").setRegistryName("undead");
	public VikingEntity(SololevelingModElements instance) {
		super(instance, 11);
		FMLJavaModLoadingContext.get().getModEventBus().register(new VikingRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7778481, -16777216, new Item.Properties().group(IdtItemGroup.tab))
				.setRegistryName("undead_spawn_egg"));
	}
